...
public class StoreSpecialDesign implements Design {

    @Override
    public List<Cell> getBarcode(ProductInfoDto dto, PdfDocument pdfDoc, BarcodeType barcodeType) {
        Cell description = new Cell().add(getProductDescription(dto)).setBackgroundColor(Color.YELLOW);
    ...
    private Cell getEanCode(ProductInfoDto dto, PdfDocument pdfDoc) {
        ...
        return new Cell().add(code128Image).setBackgroundColor(Color.YELLOW);
    }
    ...
    private Cell getQrCode(ProductInfoDto dto, PdfDocument pdfDoc) {
        ...
        return new Cell().add(qrCodeImage).setBackgroundColor(Color.YELLOW);
    }
    ...
    private String getProductDescription(ProductInfoDto dto) {
        ...
        description.append("Only in the ")
                .append(dto.getStoreName())
                .append(" store: ")
                .append(dto.getStoreAddress())
                .append(System.lineSeparator())
